"""Freeze R2 only, without editing or copying historical result artifacts."""
import hashlib
from pathlib import Path
import shutil
import sys
source=Path(sys.argv[1]); root=Path('/lustreFS/data/superworld/ckontzias/thesis/snapshots')
names=['E19-R2-LOCALIZATION-PLAN-2026-09-05.md','gdp_cem_e19_r2.py',
       'test_gdp_cem_e19_r2.py','run_gdp_cem_e19_r2.slurm','freeze_gdp_cem_e19_r2.py']
manifest=''
...
dest=root/('gdp-cem-e19-r2-'+h[:16]); dest.mkdir()
for name in names:
