...
p('Total 19365 GPU-allocation seconds = 5.379167 GPU-allocation hours, including 23 seconds for FAILED 304189. All 336 successful GPU workers reported exactly NVIDIA RTX 6000 Ada Generation on gpu09 (worker gpu09.cluster), one visible GPU; the site partition label a6000 is not the device name. The failed job lacked a measured exact device string and is not retroactively claimed to have one. Three CPU stages used 52 allocation-wall seconds, no GPU. Caps 220800/21600 seconds were unchanged. There were zero automatic retries and zero R2–R6 replacements.');p()
