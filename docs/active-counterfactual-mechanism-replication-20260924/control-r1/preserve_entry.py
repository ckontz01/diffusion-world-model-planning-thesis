...
def main():
    ...
    if a.operation=='archive':
        ...
        r.require(accepted['attempts']==8198 and accepted['recovery_approval']==ctx.approval_sha and accepted['recovery_manifest']==ctx.binding['manifest'],'R1 final acceptance required')
