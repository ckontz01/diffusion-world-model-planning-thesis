...
def main():
    ...
    if a.operation=='archive':
        ...
        r.require(accepted['attempts']==8199 and accepted['recovery_approval']==ctx.approval_sha and accepted['recovery_manifest']==ctx.binding['manifest'],'R2 final acceptance required')
