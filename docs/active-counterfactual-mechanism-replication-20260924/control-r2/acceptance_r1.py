...
def full(auth,control,rows,resolution=None):
    ...
    allowed={j['key'] for j in jobs}|{'reused','submissions','submissions-r1','submissions-r2','recovery-history','logs','ALL-MODELS-FROZEN.json','TECHNICAL-TRANCHE-PASSED.json'}
