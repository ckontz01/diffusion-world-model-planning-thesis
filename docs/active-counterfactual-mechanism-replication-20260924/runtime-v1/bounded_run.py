"""Four cumulative local wall-hours, four threads, 8GiB, 1GB; all attempts retained."""
import common as c
import ctypes
...
if __name__=='__main__':
    ...
    remaining=14400-sum(r.get('wall_seconds',0) for r in rows);c.require(remaining>0,'Local wall budget')
    ...
    if result['bytes']>1_000_000_000:result['returncode']=126
