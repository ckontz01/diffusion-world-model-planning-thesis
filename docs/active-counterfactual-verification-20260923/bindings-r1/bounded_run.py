...
if __name__ == '__main__':
    ...
    publication = common.REPO / 'docs/active-counterfactual-verification-publication-20260923/execution-r1'
    ...
    common.require(remaining > 0, 'R1 two-hour cumulative budget exhausted')
    def append(value):
