...
$acvPublication = Join-Path $acvRepo 'docs/active-counterfactual-verification-publication-20260923/finalization-r5'
$acvDestination = 'D:/THESIS-BACKUPS/active-counterfactual-verification-20260923/finalization-r5'
...
if ($acvTarget -ne 'D:\THESIS-BACKUPS\active-counterfactual-verification-20260923\finalization-r5') { throw 'Unexpected destination' }
...
$acvReceipt = [ordered]@{status='VERIFIED';package_commit=$acvHead;remote_head_verified=$true;branch=$acvBranch;
    ...
    note='Only new finalization-r5 source and authority/test/preparation records. Every payload and receipt read back. Not a substitute for final research archive preservation.'}
