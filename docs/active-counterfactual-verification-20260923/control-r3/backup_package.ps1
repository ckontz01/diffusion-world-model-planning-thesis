...
$acvPublication = Join-Path $acvRepo 'docs/active-counterfactual-verification-publication-20260923/continuation-r3'
$acvDestination = 'D:/THESIS-BACKUPS/active-counterfactual-verification-20260923/control-r3'
...
if ($acvTarget -ne 'D:\THESIS-BACKUPS\active-counterfactual-verification-20260923\control-r3') { throw 'Unexpected destination' }
...
$acvReceipt = [ordered]@{status='VERIFIED';package_commit=$acvHead;remote_head_verified=$true;branch=$acvBranch;
    ...
    note='Only new control-r3 source and continuation-r3 authority/test/preparation records. Every payload and receipt read back. Not a substitute for final research archive preservation.'}
