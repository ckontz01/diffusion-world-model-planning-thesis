...
$acvPublication = Join-Path $acvRepo 'docs/active-counterfactual-verification-publication-20260923/continuation-r4'
$acvDestination = 'D:/THESIS-BACKUPS/active-counterfactual-verification-20260923/control-r4'
...
if ($acvTarget -ne 'D:\THESIS-BACKUPS\active-counterfactual-verification-20260923\control-r4') { throw 'Unexpected destination' }
...
$acvReceipt = [ordered]@{status='VERIFIED';package_commit=$acvHead;remote_head_verified=$true;branch=$acvBranch;
    ...
    note='Only new control-r4 source and continuation-r4 authority/test/preparation records. Every payload and receipt read back. Not a substitute for final research archive preservation.'}
