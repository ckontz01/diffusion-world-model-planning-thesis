...
$acvDestination = 'D:/THESIS-BACKUPS/active-counterfactual-verification-20260923/bindings-v2'
...
if ($acvTarget -ne 'D:\THESIS-BACKUPS\active-counterfactual-verification-20260923\bindings-v2') { throw 'Unexpected destination' }
...
$acvReceipt = [ordered]@{status='VERIFIED';package_commit=$acvHead;remote_head_verified=$true;branch=$acvBranch;
    ...
    note='Only new bindings-v2 technical correction package. Every member and receipt read back. Existing bindings-v1, preparation-v1 and all historical archives untouched. This backup receipt is not execution authority.'}
